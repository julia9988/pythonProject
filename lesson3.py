...
#    usd_item = "usd"   usd_usd_rate = 1
#    eur_item = 'eur'  usd_eur_rate = 0.86
...
# Результат вывести в консоль (target_currency_amount, uah_item, “=”, currency_result, uah_item)   (uah_item = "uah"      usd_uah_rate = 26.23)
if currency_convertor:
    currency_usd = usd_item
...
#    chf_item = "chf"       usd_chf_rate = 0.91
 #   rub_item = "rub"       usd_rub_rate = 71.88     #   byn_item = "byn"       usd_byn_rate = 2.46
if currency_convertor:
    currency_usd = usd_item
