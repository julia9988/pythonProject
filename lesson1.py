...
result_mp_s_root = pow(item_1, 2)
# 18. Вывести result_mp_s_root в консоль.
print("result_mp_s_root - квадратный корень из числа 25 = ", result_mp_s_root)
...
print("result_division деление = ", result_division)
...
print("result_m_floor округление до ближ меншего числа = ", result_m_floor)
...
print("result_m_ceil округление до ближ большоего числа = ", result_m_ceil)
...
print("result_int приведение до ближ целого числа = ", result_int)
...
print("result_no_division_loss деление без остатка = ", result_no_division_loss)
...
print("result_division_loss деление c остат = ", result_division_loss)
...
print("boolean b_item_t + b_item_f = ", b_item_relult_sum)
...
print(" boolean b_item_t - b_item_f = ", b_item_relult_subtr)
...
print(" boolean b_item_t * b_item_f = ", b_item_relult_multi)
...
# print(" boolean b_item_t / b_item_f = ",b_item_relult_division)
...
print("b_item_1_int = int(b_item_t) = ", b_item_1_int)
# 60. Создать переменную b_item_2_int и присвоить явное приведение b_item_f к int
b_item_2_int = int(b_item_f)
# 61. Вывести b_item_2_int в кон
print("b_item_2_int = int(b_item_f) = ", b_item_2_int)